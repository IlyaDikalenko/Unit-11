...
function f4() {
    let inputIn = document.querySelector('.i-4').value;
    d1.push(inputIn)
    showArr('.out-4', d1);
}
...
function f5() {
    let inputIn = document.querySelector('.i-5').value;
    d1.unshift(inputIn)
    showArr('.out-5', d1);
}
...
function f8() {
    let inputIn = document.querySelector('.i-8').value;
...
function f11() {
    let inputIn = +document.querySelector('.i-11').value;
    let index = d11.indexOf(inputIn)
...
function f12() {
    ...
    document.querySelector('.out-12').innerHTML = found
}
...
function f13() {
for (let i = 0; i < Math.floor(d13.length / 2); i++) {
    let temp = d13[i];
    d13[i] = d13[d13.length - 1 - i];
    d13[d13.length - 1 - i] = temp;
}
    showArr('.out-13', d13);
}
...
function f14() {
    let inputIn = +document.querySelector('.i-14').value;
    for (let i = 0; i < inputIn; i++) {
        d14.push(1)   
    }
    showArr('.out-14', d14);
}
...
function f15() {
    let inputIn = +document.querySelector('.i-15').value;
    if (d15.indexOf(inputIn) == -1) {
        d15.push(inputIn)
    }
    showArr('.out-15', d15);
}
...
function f18() {
    let inputIn = document.querySelector('.i-18').value;
    let include = d18.includes(inputIn);
    document.querySelector('.out-18').innerHTML = include
}
...
function f20() {
let join = d20.join('');
    document.querySelector('.out-20').innerHTML = join;
}
